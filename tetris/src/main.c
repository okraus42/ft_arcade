...
int main(void)
{
	...
	printf("Player 1: %8u %3u %4u\nPlayer 2: %8u %3u %4u\n", game.tetris[PLAYER_1].score, game.tetris[PLAYER_1].level,
		   game.tetris[PLAYER_1].lines, game.tetris[PLAYER_2].score, game.tetris[PLAYER_2].level,
		   game.tetris[PLAYER_2].lines);
	cleanup(&game);
	return 0;
}
